...
const topics = [
  {
    prompt: "React 19의 새로운 기능들: Server Components와 Concurrent Features 완벽 가이드. 실제 프로덕션 적용 사례와 성능 개선 데이터.",
    keywords: ["react 19", "server components", "concurrent features", "react", "performance"],
  },
  {
    prompt: "불안 장애 약물 없이 극복한 방법: CBT, 명상, 운동의 시너지 효과. 3개월간의 상세한 회복 과정 기록.",
    keywords: ["불안장애", "cbt", "명상", "mental health", "anxiety"],
  },
  {
